...
from (values
  ...
  ('Barrier Reef & Coral Garden Snorkel', 'ky-sail-1', 'Sailboats off Seven Mile Beach, Grand Cayman', 0),
  ...
  ('Swim with Turtles & Shipwrecks', 'bb-carlisle-1', 'Carlisle Bay, Bridgetown, Barbados', 0),
  ...
  ('Oistins Friday Night Fish Fry', 'bb-oistins-1', 'Miami Beach at Oistins, Christ Church, Barbados', 0),
